...
# Project Analysis: Smart Football Club Administration
...
This document supports the learning outcome **Analysis** by showing that the project is researched methodically before deciding what the software should solve.
